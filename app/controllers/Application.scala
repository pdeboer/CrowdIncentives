...
case class Template(id: Long, name: String = "", doubleValuesSummed: Boolean = false, multiPartSelection: Boolean = false, doubleValueName: String = null, globalName: String = "", globalDescription: String = "", globalLinkName: String = "Create Global", partLinkPrefix: String = "Create", onlineDisplay:Boolean=true, globalSummaryTitle:String=null)
